...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : '#tb',
			url : "${pageContext.request.contextPath}/firstApeAction_pageQuery.action",
			idField : 'fa_id',
			columns : columns,
	...
	function doDblClickRow(rowIndex, rowData){
		window.location.href="${pageContext.request.contextPath}/secondApeAction_load.action?sa_id="+rowData.fa_id;
	}
