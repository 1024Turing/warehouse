...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : '#tb',
			url : "${pageContext.request.contextPath}/applyAction_mypageQuery.action",
			idField : 'ao_id',
			columns : columns,
	...
	function doDblClickRow(rowIndex, rowData){
		...
		window.location.href="${pageContext.request.contextPath}/applyAction_myload.action?ao_id="+rowData.ao_id;
	...
	function doAdd(){
		window.location.href="${pageContext.request.contextPath}/page_apply_apply.action";
...
<body class="easyui-layout" style="visibility:hidden;">
	<div id="tb" style="padding:3px">
		<a href="javascript:void(0)" class="easyui-linkbutton" plain="false" onclick="doAdd()" data-options="iconCls:'icon-add'" style="margin-left:20px">添加</a>
