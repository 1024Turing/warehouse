...
<script type="text/javascript">
	...
	function doDblClickRow(rowIndex, rowData){
		window.location.href="${pageContext.request.contextPath}/buyAction_load.action?bo_id="+rowData.bo_id;
	}

	function doAdd(){
		window.location.href="${pageContext.request.contextPath}/page_buy_buywrite.action";
