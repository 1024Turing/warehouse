...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : '#tb',
			url : "${pageContext.request.contextPath}/secondApeAction_pageQuery.action",
			idField : 'sa_id',
			columns : columns,
	...
	function doDblClickRow(rowIndex, rowData){
		window.location.href="${pageContext.request.contextPath}/pactAction_load.action?pact_id="+rowData.sa_id;
	}
...
<body class="easyui-layout" style="visibility:hidden;">
	<div id="tb" style="padding:3px">
		...
		<a href="javascript:void(0)" class="easyui-linkbutton" plain="false" onclick="doSearch('1')" style="margin-left:20px">已签</a>
		<a href="javascript:void(0)" class="easyui-linkbutton" plain="false" onclick="doSearch('2')" style="margin-left:20px">未签</a>
