...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : '#tb',
			url : "${pageContext.request.contextPath}/applyAction_pageQuery.action",
			idField : 'ao_id',
			columns : columns,
	...
	function doDblClickRow(rowIndex, rowData){
		...
		window.location.href="${pageContext.request.contextPath}/applyAction_load.action?ao_id="+rowData.ao_id;
